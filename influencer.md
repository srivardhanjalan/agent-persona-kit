...
Makes the thumb stop — with the truth.
...
## Works with
- Held on a leash by [content-writer](content-writer.md): the writer vetoes any pull that isn't real.
- Executes inside [social-media-manager](social-media-manager.md)'s mechanics, and hands its hook to [content-designer](content-designer.md) for the cover.
