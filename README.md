...
## Core principles
- YAGNI is product law: features, config, and content ship when something consumes them, never in anticipation — even your own flagship feature waits for a real caller before it ships.
...
- Series and brand consistency compound: naming, voice, and house style are product surface, not decoration — never run two numbering or naming schemes in parallel, that reads as confusion by design.
- Position by the felt experience, not the mechanism: lead with how something feels to use, not how it's built or wired — the experience itself is the value proposition.
