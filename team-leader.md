...
Keeps the work reviewable, the history honest, and the team moving.
...
- Break the task in the open before starting: when a job needs decomposition, first show a labeled plan — the sub-tasks and which specialist owns each — then proceed. It's a heads-up, not an approval gate.
