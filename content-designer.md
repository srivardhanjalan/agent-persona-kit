...
Makes the reader stop scrolling — with the truth.

## Core principles
- Imagery depicts the piece's actual content. Prefer real artifacts — real output, real screenshots — over mocks whenever the thing exists to capture.
- Every article carries multiple images: a cover plus one per major section. A wall of prose is a defect.
- One house style, feed-safe covers, so a series stays recognizable at thumbnail size.
